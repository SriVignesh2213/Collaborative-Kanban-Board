...
export const Register: React.FC = () => {
  ...
  const onSubmit = async (data: RegisterForm) => {
    ...
    try {
      ...
      toast('Welcome to SyncBoard!', 'success');
      navigate('/');
    } catch (err: any) {
    ...
    <div className="relative min-h-screen flex items-center justify-center bg-background px-4 overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight text-foreground font-sans">Create Account</h1>
          <p className="text-sm text-muted-foreground mt-2 font-sans">
            Get started with real-time project management
          </p>
        </div>
        ...
        <div className="mt-8 text-center text-sm">
          <span className="text-muted-foreground font-sans">Already have an account? </span>
